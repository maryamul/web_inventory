...
CREATE TABLE `barang` (
  ...
  `kondisi_barang` varchar(80) DEFAULT NULL,
...
INSERT INTO `barang` (`id`, `kode_barang`, `nama_barang`,`kondisi_barang`, `stok`, `satuan`) VALUES
(1, '36143613', 'Keyboard', 'Baik', 12, 'pcs'),
(2, '15747218', 'Mouse','Baik', 6, 'pcs');
